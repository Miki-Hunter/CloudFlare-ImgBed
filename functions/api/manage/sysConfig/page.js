...
export async function getPageConfig(db, env) {
    ...
    config.push(
        ...
        },
        {
            ...
            label_en: 'Logo Link',
            placeholder: '/',
            tooltip: '点击Logo时跳转的链接，默认为首页 /',
            tooltip_en: 'URL to navigate when clicking the logo. Default is home page /',
            category: '全局设置',
            category_en: 'Global Settings',
        },
        {
        ...
        },
        {
            ...
            placeholder: '/browse/',
            tooltip: '默认添加浏览画廊链接 /browse/',
            tooltip_en: 'Default link to gallery /browse/',
            category: '客户端设置',
            category_en: 'Client Settings',
        },
        {
